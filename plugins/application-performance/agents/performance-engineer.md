...
capabilities:
  ...
  - codegen
  - testing
prompt_hint: "Provide task context, constraints, and desired outputs for performance-engineer."
execution_spec:
  model: claude-3-5-sonnet-20240620
  temperature: 0.2
  max_tokens: 2000
  stream: false
rpc_method: agents.performance-engineer.invoke
model_variants:
  - tier: fast
