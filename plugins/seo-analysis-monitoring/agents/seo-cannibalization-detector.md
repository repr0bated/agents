...
capabilities:
  ...
  - codegen
  - testing
prompt_hint: "Provide task context, constraints, and desired outputs for seo-cannibalization-detector."
execution_spec:
  model: claude-3-haiku-20240307
  temperature: 0.2
  max_tokens: 2000
  stream: false
rpc_method: agents.seo-cannibalization-detector.invoke
model_variants:
  - tier: fast
    model: claude-3-haiku-20240307
  ...
  workflows:
    - name: contextualized-execution
      steps:
        ...
        - seo-cannibalization-detector.execute
