...
capabilities:
  ...
  - codegen
  - testing
prompt_hint: "Provide task context, constraints, and desired outputs for backend-security-coder."
execution_spec:
  model: claude-3-5-sonnet-20240620
  temperature: 0.2
  max_tokens: 2000
  stream: false
rpc_method: agents.backend-security-coder.invoke
model_variants:
  - tier: fast
  ...
  workflows:
    - name: contextualized-execution
      steps:
        ...
        - backend-security-coder.execute
